...
class Yolov5():
    ...
    def detect(self,signal_images=None,save_img=False):
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--source', type=str, default='data/images/test.mp4', help='source')  # file/folder, 0 for webcam
